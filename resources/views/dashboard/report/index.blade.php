    ...
    <div class="fade-in">
        <div class="card">
            <div class="card-header d-flex justify-content-between">
                <form action="/report" method="GET" style="width: 50%">
                ...
                <div class="btn-group" role="group" aria-label="First group">
                    <a href="/report/export/{{ $bulan }}/{{ $tahun }}" class="btn btn-primary" type="button">
                ...
                <table class="table table-bordered" id="table-report" style="width:100%; overflow-x: auto;">
                    <thead>
                      <tr>
                        ...
                        <th class="align-middle" rowspan="2">Kesatuan</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle">
                                <a href="/report/kesatuan/{{ $data->id }}" class="text-success">{{ $data->instansi }}</a>
                            </td>
                    ...
                    {{-- <tfoot>
                        <tr>
                            <th class="align-middle text-center" colspan="2">Jumlah Keseluruhan</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['simpanan']['total_sim_pokok'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['simpanan']['total_sim_wajib'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['simpanan']['total_sim_sukarela'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['potongan']['total_pot_uang'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['potongan']['total_pot_barang'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['potongan']['total_pot_bahan'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total['potongan']['total_pot_lain'], 0, ',', '.') }}</th>
                            <th class="align-middle text-right">Rp. {{ number_format((int) $total_semua_transaksi, 0, ',', '.') }}</th>
                          </tr>
                    </tfoot> --}}
                </table>
            </div>
