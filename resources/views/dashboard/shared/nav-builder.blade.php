...
?>
        ...
        <div class="c-sidebar-brand">
            {{-- <img class="c-sidebar-brand-full" src="{{ url('/assets/img/logo.png') }}" width="118" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/img/logo.png') }}" width="118" height="46" alt="CoreUI Logo"> --}}

            <img class="c-sidebar-brand-full" src="{{ url('/assets/img/logo-brand.png') }}" height="46" alt="CoreUI Logo">
            <img class="c-sidebar-brand-minimized" src="{{ url('assets/img/logo-brand.png') }}" height="46" alt="CoreUI Logo">
